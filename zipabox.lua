...
log:info("starting Netatmo command line utility to push data to a url")
log:info("Now entering an endless loop. Checking every %s seconds", config.push_interval)
